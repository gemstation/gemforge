  ...
  etherscan: {
    ...
    it('tries to verify the contracts', async () => {
      ...
      if (framework === 'hardhat') {
        ...
        checkFor = `forge verify-contract ${diamondAddress} src/generated/DiamondProxy.sol:DiamondProxy --constructor-args ${argsStr} --verifier-url http://localhost:${mockServerPort}/api --verifier-api-key dummy-key --watch`
      }
    ...
    it('verifies with custom verifier parameter', async () => {
      ...
      const argsStr = (exec(`cast abi-encode "constructor(address)" ${owner}`).stdout).toString().trim()
      const checkFor = `forge verify-contract ${diamondAddress} src/generated/DiamondProxy.sol:DiamondProxy --constructor-args ${argsStr} --verifier-url http://localhost:${mockServerPort}/api --verifier-api-key dummy-key --verifier blockscout --watch`
    ...
    it('verifies with custom chainId parameter', async () => {
      ...
      const argsStr = (exec(`cast abi-encode "constructor(address)" ${owner}`).stdout).toString().trim()
      const checkFor = `forge verify-contract ${diamondAddress} src/generated/DiamondProxy.sol:DiamondProxy --constructor-args ${argsStr} --verifier-url http://localhost:${mockServerPort}/api --verifier-api-key dummy-key --chain 31337 --watch`
    ...
    it('verifies with both verifier and chainId parameters', async () => {
      ...
      const argsStr = (exec(`cast abi-encode "constructor(address)" ${owner}`).stdout).toString().trim()
      const checkFor = `forge verify-contract ${diamondAddress} src/generated/DiamondProxy.sol:DiamondProxy --constructor-args ${argsStr} --verifier-url http://localhost:${mockServerPort}/api --verifier-api-key dummy-key --verifier blockscout --chain 31337 --watch`
    ...
    it('verifies without apiKey (optional apiKey)', async () => {
      ...
      const argsStr = (exec(`cast abi-encode "constructor(address)" ${owner}`).stdout).toString().trim()
      const checkFor = `forge verify-contract ${diamondAddress} src/generated/DiamondProxy.sol:DiamondProxy --constructor-args ${argsStr} --verifier-url http://localhost:${mockServerPort}/api  --watch`
    ...
    it('verifies with verifier and chainId but without apiKey', async () => {
      ...
      const argsStr = (exec(`cast abi-encode "constructor(address)" ${owner}`).stdout).toString().trim()
      const checkFor = `forge verify-contract ${diamondAddress} src/generated/DiamondProxy.sol:DiamondProxy --constructor-args ${argsStr} --verifier-url http://localhost:${mockServerPort}/api  --verifier blockscout --chain 31337 --watch`
